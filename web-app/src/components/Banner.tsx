        ...
        return (
            <header className='Banner Banner-flex-row'>
                <div className='Banner-menu Banner-menu-flex-row'>
                    <FaHouseUser className='Banner-menu-icon Icon-medium' id="icon-home"/>
                    <FaSearch className='Banner-menu-icon Icon-medium' id="icon-search"/>
                    <FaRegBell className='Banner-menu-icon Icon-medium' id="icon-notificacoes"/>
                    <FaRegEnvelope className='Banner-menu-icon Icon-medium' id="icon-mensagens"/>
                </div>
            </header>
        );
        ...
        return (
            <header className='Banner Banner-flex-column Banner-small'>
                <div className='Banner-menu Banner-menu-flex-column'>
                    <FaTwitter className='Banner-menu-icon Icon-medium' id="icon-twitter" fill='rgb(29, 155, 240)'/>
                    <FaHouseUser className='Banner-menu-icon Icon-medium' id="icon-home"/>
                    <FaSearch className='Banner-menu-icon Icon-medium' id="icon-search"/>
                    <FaSlackHash className='Banner-menu-icon Icon-medium' id="icon-explorar"/>
                    <FaRegBell className='Banner-menu-icon Icon-medium' id="icon-notificacoes"/>
                    <FaRegEnvelope className='Banner-menu-icon Icon-medium' id="icon-mensagens"/>
                    <FaRegBookmark className='Banner-menu-icon Icon-medium' id="icon-itens-salvos"/>
                    <FaBook className='Banner-menu-icon Icon-medium' id="icon-listas"/>
                    <FaUserAlt className='Banner-menu-icon Icon-medium' id="icon-perfil"/>
                    <FaRegCommentDots className='Banner-menu-icon Icon-medium' id="icon-listas"/>
                </div>
        ...
        return (
            <header className='Banner Banner-flex-column Banner-large'>
                ...
                <div className='Banner-menu Banner-menu-flex-column'>
                    ...
                    <div className='Icon-container'>
                        <FaRegCommentDots className='Banner-menu-icon Icon-medium' id="icon-mais"/>
